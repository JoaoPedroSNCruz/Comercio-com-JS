...
export function renderizarCatalogo() {
    for(const produtoCatalogo of catalogo) {
        ...
        const cartaoProduto = 
        `<div class='group rounded-lg shadow-xl shadow-slate-400 m-2 w-48 flex flex-col p-2 justify-between ${produtoCatalogo.feminino ? 'feminino' : 'masculino'}' id="card-produto-${produtoCatalogo.id}">
