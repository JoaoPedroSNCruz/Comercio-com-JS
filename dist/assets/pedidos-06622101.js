import{l as d,d as n}from"./utilidades-7e96fa01.js";function r(o){const i=`<p class='text-xl text-bold my-4' >${new Date(o.dataPedido).toLocaleDateString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</p>
